...
| 数据分析 | 图表生成 | 数据写入 |
|:---:|:---:|:---:|
| ![示例1](./docs/example1.png) | ![示例2](./docs/example2.png) | ![示例3](./docs/example3.png) |

### 后端控制台

| Agent 调用过程 | 工具执行日志 |
|:---:|:---:|
| ![后端1](./docs/bg_1.png) | ![后端2](./docs/bg_2.png) |

### 示例文件

- **输入文件**: [`docs/按部门统计消费金额.xlsx`](./docs/按部门统计消费金额.xlsx)
- **输出文件**: [`docs/按部门统计消费金额_modified.xlsx`](./docs/按部门统计消费金额_modified.xlsx)
...
- ✅ **行高列宽**: 设置行高、列宽、自动调整
- ✅ **文件下载**: 浏览器下载修改后的文件
- ✅ **Skills 架构**: 参考 [Claude Code Skills](https://code.claude.com/docs/en/skills) 重构技能系统，支持模块化技能加载
